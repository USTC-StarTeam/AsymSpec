...
class GPUModelRunner(
    ...
    def _sample(
        ...
        # SpecSteer dispatch: route greedy specsteer drafter through the
        # δ-fusion + CDA-gated sampler. Other paths (non-greedy, or non-
        # specsteer drafter) keep the vanilla rejection_sampler.
        from vllm.v1.spec_decode.specsteer_model import SpecSteerProposer
        if isinstance(self.drafter, SpecSteerProposer) and sampling_metadata.all_greedy:
            sampler_output = self._specsteer_sample(

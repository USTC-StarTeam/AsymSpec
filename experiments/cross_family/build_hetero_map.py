...
ap.add_argument("--drafter", default="meta-llama/Llama-3.2-3B-Instruct")
ap.add_argument("--verifier", default="Qwen/Qwen3-32B")
...
SPECIALS = [
    (128009, 151645),   # llama <|eot_id|>        <-> qwen <|im_end|>
    (128001, 151643),   # llama <|end_of_text|>   <-> qwen <|endoftext|>
]
for aid, bid in SPECIALS:
    a2b[aid] = bid
    b2a[bid] = aid
a2b[128008] = 151645    # llama <|eom_id|> -> qwen <|im_end|> (one-way)
...
assert int(a2b[128009]) == 151645 and int(b2a[151645]) == 128009
